...
%---------------------------------------------------------------------------
\projectinfo{
  date={19. června 2025}, % Datum - je vhodné vepsat datum obhajoby (natvrdo), ne datum kompilace slajdů / Date - it is advisable to write the date of the defense (hard), not the date of the slide compilation        
  title={Aplikace pro plánování\\cyklistických výjezdů}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
  title.footer={Aplikace pro plánování cyklistických výjezdů}, % Název prezentace - text zobrazovaný vedle čísla slajdu / Presentation title - displayed next to the slide number (The full title of the presented work, it may be suitably abbreviated to fit the footer)
  ...
  supervisor.name={Juraj}, % Jméno vedoucího / Supervisor name
  supervisor.surname={Lazúr}, % Příjmení vedoucího / Supervisor surname
  supervisor.title.first={Ing.}, % Tituly před jménem / Supervisor's titles before the name
  supervisor.title.last={} % Tituly za jménem / Supervisor's titles after the name
}
