...
// @brief Source code of the mobile analysis page implementation.
// @date 2025-05-14
//
...
class AnalysisPageMobileLayout extends StatefulWidget {
  const AnalysisPageMobileLayout({super.key});

  @override
  State<AnalysisPageMobileLayout> createState() => _AnalysisPageMobileLayoutState();
}

class _AnalysisPageMobileLayoutState extends State<AnalysisPageMobileLayout> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Provider.of<TripProvider>(context, listen: false).tripData == null
      ? LayoutBuilder(
