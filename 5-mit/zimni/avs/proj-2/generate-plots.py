...
parser.add_argument('plot-type', type=str, choices=['input-strong', 'input-weak', 'grid-scaling'])
...
with open(args.input, newline='') as inputFile:
    ...
    if args.plot_type == 'input-strong':
        tables = {}
        builderNames = set()
        threadCnts = set()
        fieldElemsCnts = set()
    ...
    elif args.plot_type == 'input-weak':
        tables = {}
        builderNames = set()
        threadCnts = set()
        fieldElemsCnts = set()
    ...
    elif args.plot_type == 'grid-scaling':
        tables = {}
        builderNames = set()
        gridSizes = set()
        for row in inputReader:
