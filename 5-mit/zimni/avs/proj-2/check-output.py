...
parser.add_argument('ref-input', type=str, help='an output of the reference implementation')
parser.add_argument('test-input', type=str, help='an output of the implementation under the test')
