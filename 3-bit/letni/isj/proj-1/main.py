...
def camel_to_snake_case(name):
    ...
    inbetween = re.compile(r'''
                            ...
                            |                       # or
                                (?<=[a-zA-Z])       # in front of an uppercase
...
def not_both_titles(names_string):
    ...
    pat = re.compile(r'''
                        (?<![Pp]rof\.\s)(?<![Dd]oc\.\s)\b[a-zA-Z]+\s[a-zA-Z]+\b(?!,\sPh\.D\.)                               # it is either
                    |                                                                                                       # or
                        (?<=,\s)\b[a-zA-Z]+\s[a-zA-Z]+\b\,\sPh\.D\.|\b[a-zA-Z\.\s]+[a-zA-Z]+\s[a-zA-Z]+\b(?!,\sPh\.D\.)     # it is
                      ''', re.X)
