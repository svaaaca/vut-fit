...
def solfege(title_hymn):
    ...
    possible_title, sep, hymn = title_hymn.partition(': ')       # vase reseni

    # the hymn as a list of strings separated by ' '
    hymn_list = hymn.split() if sep else possible_title.split()  # vase reseni
    
    # skipping always two strings, and ending 3 strings from the end
    skip2 = hymn_list[:len(hymn_list)-3:3]                       # vase reseni
