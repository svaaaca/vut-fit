...
-- @brief Top level simulation file for the project.
-- @date 2024-05-14
--
...
-- Top entity for simulation.
entity top_sim is
end top_sim;

-- Architecture for the top entity.
architecture Behavioral of top_sim is
    ...
    -- Signal for the clock simulation.
    ...
    -- Signal vector for the output column to be displayed.
